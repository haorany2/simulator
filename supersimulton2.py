...
class Super_simulton2(Simulton):
    radius=5
    check1=False
    check2=False
    check3=False
    ...
    def __init__(self,x,y,angle,speed):
        Simulton.__init__(self,x,y,Super_simulton2.radius,Super_simulton2.radius)  #####how large are these robots, need to dis
        self._angle = angle
        self._speed = speed
...
#         self.wall_bounce()
    ...
    def display(self,canvas):
        ...
        canvas.create_oval(self._x-Super_simulton2.radius      , self._y-Super_simulton2.radius,
        self._x+Super_simulton2.radius, self._y+Super_simulton2.radius,
        fill='green')
...
#         
        ...
        if Super_simulton2.robot_busy==False and Super_simulton2.check4==True and model.scan_time2==0:#need to go confirm session
            ...
            if lst!=None:
                for i in lst:
                    if i[4]==False:
                        i[4]=True
                        Super_simulton2.current_victum_mission=(i[0],i[1],i[2],i[3])
                        Super_simulton2.robot_busy=True
                        break
            else:#shouldnt come to this
                print(lst)
            print("current_victum_mission2:::",Super_simulton2.current_victum_mission)
        if   Super_simulton2.robot_busy==True:  
                Super_simulton2.finish_mission=(self.move_close_to_destiniation(Super_simulton2.current_victum_mission[0],Super_simulton2.current_victum_mission[2]))
        ...
        if   Super_simulton2.finish_mission:
            ...
            for i in list(model.static_simultons):
                ...
                if (Super_simulton2.current_victum_mission[1]-Super_simulton2.current_victum_mission[0])/2+Super_simulton2.current_victum_mission[0]==i.get_location()[0] and (Super_simulton2.current_victum_mission[3]-Super_simulton2.current_victum_mission[2])/2+Super_simulton2.current_victum_mission[2]==i.get_location()[1]:
